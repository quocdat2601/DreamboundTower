...
namespace Map
{
    public class MapView : MonoBehaviour
    {
        ...
        protected virtual void CreateMapBackground(Map m)
        {
            ...
            backgroundObject.transform.localPosition = new Vector3(centerX, span / 2f, 0f);
        ...
        protected virtual void SetOrientation()
        {
            ...
            switch (orientation)
            {
                ...
                case MapOrientation.RightToLeft:
                    ...
                    // factor in map span:
                    {
                        float bossY = bossNode != null ? bossNode.transform.position.y : 0f;
        ...
        {
            if (mapManager == null || mapManager.CurrentMap == null || floorDisplayText == null) return;
            ...
            // Chỉ còn lại phần cập nhật cho UI Text
